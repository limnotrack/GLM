...
# endif
   ...
   IF ( aed_write_nml_mode ) THEN
      ...
      models(2) = 'aed_oxygen'
      models(3) = 'aed_silica'
      models(4) = 'aed_nitrogen'
      models(5) = 'aed_phosphorus'
      models(6) = 'aed_organic_matter'
      models(7) = 'aed_phytoplankton'
      models(8) = 'aed_totals'
      ...
      CALL aed_nml_wsa(namlst, 'models', models, 8, 'Active AED modules, in the order their sections appear below')
      WRITE(namlst,'(A)') "/"
      WRITE(namlst,'(A)') ""
   ELSE
